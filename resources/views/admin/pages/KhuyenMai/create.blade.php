...
<div class="main-panel">
  ...
  @endif
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <label for="exampleInputTitle">Khuyến Mãi Theo Số Tiền</label>
                    <input class="form-control" type="text" name="ChietKhau" id="ChietKhau" placeholder="Nhập số tiền khuyến mãi">
                  </div>
                </div>
