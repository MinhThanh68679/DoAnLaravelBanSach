            ...
            @method('PUT')
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <input class="form-control" type="text" name="Code" value="{{$magiamgia->Code}}" id="Code" placeholder="Mã giảm giá">
                  </div>
                  <div class="col-lg-6">
                    <label for="exampleInputTitle">Số Lượng</label>
                    <input class="form-control" type="text" name="SoLuong" value="{{$magiamgia->SoLuong}}" id="SoLuong" placeholder="Số lượng">
                  </div>
                </div>
                <div class="row">
                <div class="col-lg-6">
                    <label for="exampleInputTopic">Loại Khuyến Mãi</label>
                    <select  id="gender" onchange="genderChanged(this)" value="{{$magiamgia->LoaiKM}}" style="border: 1px solid #CED4DA;border-radius: 4px; outline: none;" name="LoaiKM" class="form-control" id="LoaiKM" placeholder="Title">
                  ...
                  <label for="exampleInputTopic">Nhập Số Phần Trăm Hoặc Số Tiền</label>
                    <input class="form-control" type="text" onclick="Changed(this)" value="{{$magiamgia->ChietKhau}}" name="ChietKhau" id="ChietKhau1" placeholder="Vui lòng nhập từ 1-100">
                    
                    <input class="form-control" type="text" name="ChietKhau" value="{{$magiamgia->ChietKhau}}" hidden id="ChietKhau2" placeholder="Vui lòng nhập từ 1000 trở lên">

                                   </div>
                  
                  <div class="col-lg-6">
                    <label for="exampleInputTopic">Ngày Bắt Đầu</label>
                    <input class="form-control" type="date" name="NgayBĐ" value="{{$magiamgia->NgayBĐ}}" id="NgayBĐ" placeholder="Ngày bắt đầu">
                  </div>
                </div> 
                <div class="row">
                  <div class="col-lg-6">
                    <label for="exampleInputTitle">Ngày Kết Thúc</label>
                    <input class="form-control" type="date" name="NgayKT" value="{{$magiamgia->NgayKT}}" id="NgayKT" placeholder="Ngày kết thúc">
                  </div>
                  <div class="col-lg-6">
