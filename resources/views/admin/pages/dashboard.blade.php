                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                <p class="mb-4">Thống Kê Theo Đơn Hàng trong 30 Ngày</p>
                                <p class="fs-30 mb-2">{{number_format($totalMoneyInMonth,0,",",".")}} ₫</p>
                                <p>{{number_format($totalMoneyInMonth,0,",",".")}} ₫ (30 days)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4 stretch-card transparent">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <canvas id="chartHoadon" width="400" height="100"></canvas>
                    </div>
                </div>
            </div>
            <div class="col-md-6 grid-margin stretch-card">
