            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                ...
                <div class="alert alert-success alert-dismissible fade show notify" role="alert">
                  ...
                  <div class="col-lg-6">
                  <a class="btn btn-primary" href="{{ route('magiamgia.create')}}" style="padding: 0.7rem 1.5rem; border-radius: 10px; margin-left:10px;"><i class='fas fa-plus' style='font-size:15px'></i></a>
                  </div>
                  <div class="col-lg-6">
                  ...
                  <tr>
                    ...
                    @else (($magiamgias->LoaiKM == 0)) {{"Khuyến Mãi Theo Tiền"}}
                    @endif</td>
                    ...
                    <a onclick="return ComfirmDelete();" href="{{ route('magiamgia.delete', [$magiamgias->id]) }}" class="btn btn-danger" style="padding: 0.5rem 1.5rem; border-radius: 10px;"><i class='fas fa-trash-alt' style='font-size:15px'></i></a>
