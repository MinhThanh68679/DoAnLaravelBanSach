            ...
            <!-- form start -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <input class="form-control" type="text" name="NhaXuatBan" id="NhaXuatBan" placeholder="NhaXuatBan">
                  </div>
                </div> 
                <div class="row">
                  <div class="col-lg-6">
                    <label for="exampleInputTitle">Tác Giả</label>
                    <input class="form-control" type="text" name="DichGia" id="DichGia" placeholder="Tác giả">
                  </div>
                  <div class="col-lg-6">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <input class="form-control" type="date" id="KichThuoc" name="NamXB" placeholder="NamXB" style="margin-right:50px" >
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <input class="form-control" type="text" id="KichThuoc" name="KichThuoc" placeholder="Kích thước" style="margin-right:50px" >
                  </div>
                                    <div class="col-lg-12">
